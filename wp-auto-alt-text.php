 ...
 * Description: Enhances the WordPress Media Library with "Review & Improve" and "Regenerate" bulk actions for AI-powered alt text using the WP 7.0 AI Client. Supports browser-based, WP-Cron background, and WP-CLI processing.
 * Version:     1.2.0
